...
class IcdController {
  ...
  async search(req, res) {
    try {
      ...
      return res.status(500).json({ message: 'Lỗi khi tìm kiếm bệnh từ WHO ICD-11: ' + err.message });
    }
  }
  ...
  async detail(req, res) {
    try {
      ...
      return res.status(500).json({ message: 'Lỗi khi lấy chi tiết bệnh: ' + err.message });
    }
  }
