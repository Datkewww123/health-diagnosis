...
export default function Booking() {
  ...
  const handleSelectRegistered = async () => {
    if (!user) {
  ...
  if (successBooking) {
    ...
    const sttNum = String((successBooking.id % 99) + 1).padStart(2, "0");
            ...
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-sky-500/10 rounded-lg">
                  <HospitalIcon className="h-4 w-4 text-sky-600 dark:text-sky-455" />
                </div>
                <div>
            ...
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-amber-500/10 rounded-lg">
                  <Stethoscope className="h-4 w-4 text-amber-600 dark:text-amber-455" />
                </div>
                <div>
