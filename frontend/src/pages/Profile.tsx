...
export default function Profile() {
  ...
  async function handleSave() {
    ...
    try {
      setLoading(true);
      // Ghép 3 state ngày sinh thành YYYY-MM-DD
      ...
      console.log("[Profile] Sending update:", updatePayload);
              ...
              <div className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-4 pr-10 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-855 text-slate-800 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all text-sm"
                  />
                  <button
                    type="button"
